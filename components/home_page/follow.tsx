...
const FollowMe = () => {
  return (
    <section className="rotate-90 font-montserrat text-sm flex w-full py-10 content-end items-start justify-end z-30 fixed top-[60%] md:top-[50%] 2xl:-top-[15%] left-[45%] md:left-[40%] md:ml-14 text-white mix-blend-difference">
