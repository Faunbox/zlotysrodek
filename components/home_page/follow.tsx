...
const FollowMe = () => {
  return (
    <section className="rotate-90 font-montserrat text-sm flex w-full py-10 content-end items-start justify-end z-10 fixed bottom-[25%] md:bottom-[40%] lg:bottom-[65%] left-[40%] md:ml-14">
