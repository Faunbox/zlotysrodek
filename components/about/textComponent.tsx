    ...
    <div className="flex flex-row gap-20 lg:mx-20 text-green relative ">
      <div className="flex flex-col text-large 2xl:text-large gap-4 text-left mx-10 mb-32">
        <div className="flex flex-col lg:flex-row ">
          <div className="flex flex-col gap-2 mt-20 lg:w-6/12 2xl:w-7/12">
        ...
        <div className="flex flex-col md:flex-row lg:flex-col items-start justify-between gap-10 lg:gap-0">
          <div className="w-full md:w-6/12 lg:w-3/12 my-5 ">
            <Image
              src={"/images/AboutDorotka.jpg"}
              alt="Dorota Sojecka"
              width={350}
              height={600}
              className="lg:ml-20 object-contain lg:absolute lg:-top-10 lg:right-10 2xl:right-24"
            />
          </div>
          <div className="md:w-6/12 lg:w-full lg:mt-0 xl:mt-10 2xl:text-left 2xl:w-10/12">
            <p>
